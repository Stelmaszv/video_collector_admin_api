 ...
 */
final class Version20220815114419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movies (id INT AUTO_INCREMENT NOT NULL, serie_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, dir VARCHAR(255) NOT NULL, src VARCHAR(255) NOT NULL, show_name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, date_relesed DATE DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, back_cover VARCHAR(255) DEFAULT NULL, INDEX IDX_C61EED30D94388BD (serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
